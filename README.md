...
The 'databricks_dbt_f1' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `databricks_dbt_f1` directory. We recommend making
